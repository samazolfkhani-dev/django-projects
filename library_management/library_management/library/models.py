...
class User(AbstractUser):
    ...
    book_requests = models.ManyToManyField("Book" , through = "Request" , related_name = "requesting_users" , through_fields = ("user", "book"))
    def __str__(self):
...
class Book(models.Model):
    ...
    total_available_copies = models.PositiveIntegerField(validators=[MinValueValidator(0)])
    created_at = jmodels.jDateTimeField(auto_now_add=True)
    updated_at = jmodels.jDateTimeField(auto_now=True)
...
class Request(models.Model):
    ...
    librarian = models.ForeignKey(User, on_delete=models.SET_NULL , related_name='handled_request' , null = True , blank = True)
...
class Loan(models.Model):
    ...
    return_librarian = models.ForeignKey(User, on_delete=models.SET_NULL , related_name='returned_loans' , null=True, blank=True)
